          ...
          <div className="hero-container">
            <div className="hero-content">
              ...
              <h1 className="hero-title">
                Your<br />money <span className="gradient-text">na<br />your<br />money</span>
              </h1>
              ...
              <div className="feature-card">
                <div className="feature-icon zaps">
                  <svg width="21" height="24" viewBox="0 0 21 24" fill="none">
                    <path d="M16.3781 2.09105C16.6547 1.44886 16.4484 0.698862 15.8812 0.286362C15.3141 -0.126138 14.5406 -0.0886384 14.0109 0.370737L2.01093 10.8707C1.54218 11.2832 1.37343 11.9442 1.59374 12.5254C1.81405 13.1067 2.37655 13.5004 2.99999 13.5004H8.22655L4.62186 21.9098C4.3453 22.552 4.55155 23.302 5.11874 23.7145C5.68593 24.127 6.45937 24.0895 6.98905 23.6301L18.9891 13.1301C19.4578 12.7176 19.6266 12.0567 19.4062 11.4754C19.1859 10.8942 18.6281 10.5051 18 10.5051H12.7734L16.3781 2.09105Z" fill="#F7931A"/>
                  </svg>
                </div>
                <h3 className="feature-title">Zaps on Nostr</h3>
                <p className="feature-description">Dash sats like WhatsApp message. Support your favorite creator. Send tips in seconds.</p>
                <div className="feature-badge">
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                    <path d="M8 16C10.1217 16 12.1566 15.1571 13.6569 13.6569C15.1571 12.1566 16 10.1217 16 8C16 5.87827 15.1571 3.84344 13.6569 2.34315C12.1566 0.842855 10.1217 0 8 0C5.87827 0 3.84344 0.842855 2.34315 2.34315C0.842855 3.84344 0 5.87827 0 8C0 10.1217 0.842855 12.1566 2.34315 13.6569C3.84344 15.1571 5.87827 16 8 16ZM11.5312 6.53125L7.53125 10.5312C7.2375 10.825 6.7625 10.825 6.47188 10.5312L4.47188 8.53125C4.17813 8.2375 4.17813 7.7625 4.47188 7.47188C4.76562 7.18125 5.24062 7.17813 5.53125 7.47188L7 8.94063L10.4688 5.46875C10.7625 5.175 11.2375 5.175 11.5281 5.46875C11.8187 5.7625 11.8219 6.2375 11.5281 6.52812L11.5312 6.53125Z" fill="#00FFB2"/>
                  </svg>
        ...
        <section className="balance-section">
          <div className="balance-container">
            ...
            <div className="balance-header">
              <h2 className="balance-title">Naira first. <span className="gradient-text">Long-press → sats</span></h2>
              <p className="balance-subtitle">Click the balance to flip between Naira and Bitcoin</p>
            </div>
            <div className="balance-card">
              <div className="balance-content">
                ...
                <p className="balance-change">+12.4% this month • ₦13,780 gain</p>
              </div>
        ...
        <section className="cities-section">
          <div className="cities-container">
            <div className="cities-header">
              <h2 className="cities-title">Built for the North, the South,<br /><span className="gradient-text">everywhere</span></h2>
              <p className="cities-subtitle">Hausa, Yoruba, Igbo, Pidgin from day 1. Kaduna beta first.</p>
            </div>
            <div className="cities-card">
              <svg className="cities-pattern" width="1230" height="340" viewBox="0 0 1230 340" fill="none">
                <g opacity="0.1">
                  <path opacity="0.3" d="M615 28.3333L664.083 56.6667L634.633 85L595.367 102L556.1 90.6667L536.467 68L615 28.3333Z" fill="#F7931A"/>
                  <path opacity="0.3" d="M418.667 113.333L467.75 141.667L438.3 170L399.033 158.667L418.667 113.333Z" fill="#F7931A"/>
                  <path opacity="0.3" d="M811.333 170L860.417 198.333L830.967 226.667L811.333 170Z" fill="#F7931A"/>
                </g>
              </svg>
        ...
        <section className="waitlist-section">
          ...
          <div className="waitlist-container">
            <div className="waitlist-header">
              <h2 className="waitlist-title">MVP drops <span className="gradient-text">April 2026</span></h2>
              <p className="waitlist-subtitle">Be the first to test. Join the waitlist now.</p>
              <p className="waitlist-note">No spam. Just updates when we drop.</p>
            </div>
              ...
              <form className="waitlist-form">
                <div className="form-row">
                  <div className="form-group">
                    ...
                    <input type="text" className="form-input" placeholder="Abdullahi Ibrahim" />
                  </div>
                  <div className="form-group">
                    <label className="form-label">Phone Number</label>
                    <input type="tel" className="form-input" placeholder="0803 123 4567" />
                  </div>
                </div>
                <div className="form-group">
        ...
        <div className="footer-container">
          <div className="footer-top">
            <div className="footer-brand">
              ...
              />
              <p className="footer-description">The Moniepoint of Bitcoin. Built for Nigeria, by Nigerians.</p>
          ...
          <div className="footer-bottom">
            <p className="footer-copyright">© 2025 Sabi Wallet. All rights reserved.</p>
            ...
            <div className="footer-legal">
              ...
              <a href="#" className="footer-legal-link">License</a>
            </div>
          </div>
        </div>
      </footer>
